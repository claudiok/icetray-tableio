...
class I3FlasherInfoVectConverter(tableio.I3Converter):
    ...
    def CreateDescription(self,fivect):
        ...
        desc.add_field("rate",tableio.types.Int32, "","flasher rate") # TODO docs
        desc.add_field("brightness",tableio.types.Int32, "","brightness level (1..127)")
        
        # TODO: maybe move these out into another converter
        ...
        # no pybindings here
        #desc.add_field("pedestal_subtracted_atwd",tableio.types.Bool, "bool","flag if the pedestal was subtracted")
